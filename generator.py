...
def system_periodic_streams_Generator(period, transmission_time, offset):
...
if __name__ == "__main__":
    ...
    offset = [0, 0, 0, 0]
    system_periodic_streams = system_periodic_streams_Generator(period, transmission_time, offset)
